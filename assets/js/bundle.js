...
var _isNodeList = __webpack_require__(2);
...
var _tinySlider = __webpack_require__(29);
...
var _isNodeList = __webpack_require__(0);
...
var _hasAttr = __webpack_require__(1);

var _setAttrs = __webpack_require__(4);
...
var _removeAttrs = __webpack_require__(3);
...
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; // @version 1.1.1
// DEVELOPMENT
...
var _getSupportedProp = __webpack_require__(9);

var _append = __webpack_require__(7);

var _wrap = __webpack_require__(12);

var _unwrap = __webpack_require__(11);

var _getSlideId = __webpack_require__(19);

var _toDegree = __webpack_require__(27);

var _getTouchDirection = __webpack_require__(20);

var _hasAttr = __webpack_require__(1);

var _getAttr = __webpack_require__(18);

var _setAttrs = __webpack_require__(4);

var _removeAttrs = __webpack_require__(3);

var _removeEventsByClone = __webpack_require__(25);

var _hideElement = __webpack_require__(21);

var _showElement = __webpack_require__(26);

var _imageLoaded = __webpack_require__(22);

var _whichProperty = __webpack_require__(28);

var _addEvents = __webpack_require__(16);

var _removeEvents = __webpack_require__(24);

var _events = __webpack_require__(17);

var _jsTransform = __webpack_require__(23);
...
function tns(options) {
  ...
  function checkSlideCount() {
    ...
    if (slideCount <= items) {
      ...
      index = mode === 'gallery' ? 0 : cloneCount;
      if (index !== indexTem) {
        _events.events.emit('indexChanged', info());
      }
    ...
    if (nav) {
      if (options.navContainer) {
        ...
        for (var x = navItems.length; x--;) {
          (0, _setAttrs.setAttrs)(navItems[x], {
            'data-nav': x,
            'tabindex': '-1',
            'aria-selected': 'false',
  ...
  function addSliderEvents() {
    if (mode === 'carousel') {
      if (TRANSITIONEND) {
        (0, _addEvents.addEvents)(container, [TRANSITIONEND, onTransitionEnd]);
      }
      if (touch) {
        (0, _addEvents.addEvents)(container, [['touchstart', onTouchStart], ['touchmove', onTouchMove], ['touchend', onTouchEnd], ['touchcancel', onTouchEnd]]);
      }
    }
    if (nav) {
      for (var y = 0; y < slideCount; y++) {
        (0, _addEvents.addEvents)(navItems[y], [['click', onClickNav], ['keydown', onKeydownNav]]);
      }
    }
    if (controls) {
      (0, _addEvents.addEvents)(prevButton, [['click', onClickPrev], ['keydown', onKeydownControl]]);
      (0, _addEvents.addEvents)(nextButton, [['click', onClickNext], ['keydown', onKeydownControl]]);
    }
    if (autoplay) {
      (0, _addEvents.addEvents)(autoplayButton, ['click', toggleAnimation]);
      if (autoplayHoverPause) {
        (0, _addEvents.addEvents)(container, ['mouseover', function () {
          if (animating) {
            stopAction();
            autoplayHoverStopped = true;
          }
        }]);
        (0, _addEvents.addEvents)(container, ['mouseout', function () {
    ...
    if (nested === 'inner') {
      _events.events.on('outerResized', function () {
        resizeTasks();
        _events.events.emit('innerLoaded', info());
      });
    } else {
      (0, _addEvents.addEvents)(window, ['resize', onResize]);
      if (nested === 'outer') {
        _events.events.on('innerLoaded', runAutoHeight);
      }
    }
  }
  ...
  function checkImagesLoaded(images) {
    for (var i = images.length; i--;) {
      if ((0, _imageLoaded.imageLoaded)(images[i])) {
        images.splice(i, 1);
      }
    }
  ...
  function sliderInit() {
    ...
    _events.events.emit('initialized', info());
    if (nested === 'inner') {
      _events.events.emit('innerLoaded', info());
    }
  }
      ...
      if (active.length > 0) {
        for (var j = active.length; j--;) {
          ...
          if (button2.disabled) {
            ...
            (0, _setAttrs.setAttrs)(button2, { 'tabindex': '0' });
          }
        }
      }
    }
  ...
  var transformCore = function () {
    if (mode === 'carousel') {
      ...
      return function () {
        slideItemsOut = [];
        (0, _removeEvents.removeEvents)(slideItems[indexCached], [[TRANSITIONEND, onTransitionEnd], [ANIMATIONEND, onTransitionEnd]]);
        (0, _addEvents.addEvents)(slideItems[index], [[TRANSITIONEND, onTransitionEnd], [ANIMATIONEND, onTransitionEnd]]);
  ...
  function render() {
    ...
    _events.events.emit('transitionStart', info());
  ...
  function onTransitionEnd(event) {
    _events.events.emit('transitionEnd', info(event));
  ...
  function onTouchStart(e) {
    ...
    _events.events.emit('touchStart', info(e));
  }
  ...
  function onTouchMove(e) {
    ...
    if ((0, _getTouchDirection.getTouchDirection)((0, _toDegree.toDegree)(disY, disX), 15) === axis) {
      touchStarted = true;
      e.preventDefault();
      _events.events.emit('touchMove', info(e));
  ...
  function onTouchEnd(e) {
    ...
    if (touchStarted) {
      ...
      _events.events.emit('touchEnd', info(e));
  ...
  function onResize(e) {
    ...
    resizeTimer = setTimeout(function () {
      if (vw !== getViewWidth()) {
        resizeTasks();
        if (nested === 'outer') {
          _events.events.emit('outerResized', info(e));
        }
      }
